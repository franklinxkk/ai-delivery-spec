...
SCENARIOS = (
    ...
    Scenario(
        "Rough idea guided PRD",
        "I only have a rough idea for a CRM response system. Guide me with questions, brainstorm options, then produce a light PRD for internal alignment.",
        True,
        "Lite",
        "L1",
        frozenset({"crm-domain"}),
