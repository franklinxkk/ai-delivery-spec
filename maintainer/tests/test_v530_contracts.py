...
for relative, markers in {
    ...
    for marker in markers:
        if marker not in text:
            failures.append(f"{relative} misses v5.3.2 contract marker: {marker}")
...
if failures:
    raise SystemExit("\n".join(failures))
print("PASS: v5.3.2 language, module slices, authority, prototype evidence and Agent handoff are deterministic")
