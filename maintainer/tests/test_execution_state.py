...
PROJECTIONS = [
    ROOT / "maintainer" / "examples" / "publishing-learning-v5" / "delivery" / "projections" / "unified-prd.md",
]
...
def main() -> int:
    with tempfile.TemporaryDirectory() as raw:
        ...
        old_skill.write_text(
            (ROOT / "SKILL.md").read_text(encoding="utf-8").replace("AI Delivery Spec 5.3.3", "AI Delivery Spec 4.9.15", 1),
            encoding="utf-8",
        )
