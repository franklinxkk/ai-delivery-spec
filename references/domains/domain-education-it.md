...
| course entitlement revocation | training operator/learner | learner activated a licensed course | revoke entitlement -> inspect active learning -> notify/retain evidence | new access is blocked by rule; completed/active learning evidence and the assigned course version remain traceable |
