# Cross-Industry Requirement Assurance Lab
...
Official sources in `evals/industry-assurance-portfolio.yaml` are discovery
...
`evals/industry-assurance-portfolio.yaml` contains seven high-relevance sectors
...
```powershell
py -3 tests/test_v510_industry_assurance.py
```
