...
| Public PRD writing articles such as Woshipm 6063060 / 5264380 | Strong human-readability emphasis: reader roles, scenario description, function split, UI/interaction detail, frontend/backend concerns, and PRD preparation before writing. Risk: community articles are not official internal standards. | Strengthen scenario-first writing and role-oriented completeness without claiming access to ByteDance/Alibaba/Tencent internal originals. |
| Atlassian PRD guidance | PRD should describe purpose, behavior, and features so stakeholders align through development. | Keep PRD as the primary product truth instead of replacing it with DDD/API tables. |
| Microsoft Well-Architected business-requirement guidance | Requirements work should listen, probe, clarify, evaluate, and recommend to align technical strategy with business motivation. | Keep Stage 1 diagnosis anchors and evidence disposition before writing solution details. |
| Apple Human Interface Guidelines | Public design guidance focuses on platform experience quality, clarity, consistency, feedback, and accessibility. | Treat UI quality/accessibility as NFR and prototype evidence, not as a PRD replacement. |
