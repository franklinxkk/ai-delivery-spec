...
如果 AI Delivery Spec 帮你省了写 PRD 的时间、减少了需求返工，或者让你的 Coding Agent 不再"猜规则"——
**请给仓库点个 Star**。每一个 ⭐ 都是独立维护者继续迭代的动力，也能让更多产品经理和工程团队发现这个工具。
...
有建议或 Bug？欢迎 [提 Issue](https://github.com/franklinxkk/ai-delivery-spec/issues)。想贡献代码？看 [CONTRIBUTING.md](.github/CONTRIBUTING.md)。
