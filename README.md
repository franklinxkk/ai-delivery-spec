...
它的目标不是机械地让 PRD 变厚，而是让产品全生命周期的单一交付物或完整交付包都能被准确触发、独立评审、正确路由并在明确边界停止。v4.2.0 在生命周期能力上补齐“完整产品规格 + 工程追溯契约 + 权威证据覆盖”，避免详细 Excel、规则、字段、原型和政策附件被压缩成无法开发的概述。
...
v4.0-v4.1.0 已解决分级交付、防御性边界、模板、战略交接、精准触发、范围一致性、场景回归、全球化准备和全生命周期评审。v4.2.0 重点修复复杂 PRD 容易“有工程摘要、无完整产品规格”的问题：

- Gate 3 同时验收产品规格完整性和工程追溯契约，两者不可互相替代；
- Excel/PDF/SQL/原型/截图/规则目录进入 Source Evidence Register，要求零静默遗漏；
- 标准 PRD 按主文档、完整模块规格、工程契约三层组织；
