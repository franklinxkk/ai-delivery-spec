...
[![Version](https://img.shields.io/badge/version-5.1.7-0052A4.svg)]()
...
[SkillHub TRACE 4.6/5](https://skillhub.cn/dashboard/evaluation/ai-delivery-spec)，双安全扫描无 P0/P1 风险。
...
| **需求管理内核** | **AI Delivery Spec 5.1.7** | 准入 → 澄清 → 基线 → 变更 → 追溯 → 验收 |
